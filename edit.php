        ...
        <div class="main-content">
                ...
                <div class="card form-card fade-in" style="max-width:700px;">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data" id="edit-form">
                        ...
                        <div class="form-group">
                            <div class="gps-card">
                                <label
                                    style="display:flex;align-items:center;gap:0.5rem;margin-bottom:1rem;font-weight:600;font-size:0.875rem;">
                                ...
                                <div style="display:flex;gap:0.75rem;margin-bottom:0.85rem;">
                                    <div style="flex:1;">
                                        <label
                                            style="font-size:0.72rem;font-weight:700;text-transform:uppercase;color:var(--text-light);">Latitude</label>
                                        <input type="text" name="latitude" id="latitude" class="form-control"
                                            value="<?php echo htmlspecialchars($doc['latitude']); ?>"
                                            placeholder="Kosong = tidak ada" readonly
                                            style="background:#f8fafc;font-size:0.875rem;">
                                    </div>
                                    <div style="flex:1;">
                                        <label
                                            style="font-size:0.72rem;font-weight:700;text-transform:uppercase;color:var(--text-light);">Longitude</label>
                                ...
                                <button type="button" class="btn btn-outline w-full" id="btn-lokasi"
                                    onclick="getLocation()" title="Ambil ulang koordinat GPS posisi Anda saat ini"
                                    style="border-color:var(--primary);color:var(--primary);">
                                    <i data-feather="refresh-cw" style="width:15px;height:15px;"></i>
                                    Perbarui Lokasi GPS
                                </button>
                                <div id="lokasi-loading"
                                    style="display:none;text-align:center;margin-top:0.75rem;font-size:0.84rem;color:var(--text-muted);">
                                    <i data-feather="loader" style="width:14px;height:14px;vertical-align:middle;"
                                        class="spin"></i>
                                    Mengambil koordinat…
                                </div>
                                <div id="lokasi-preview"
                                    style="margin-top:0.6rem;text-align:center;<?php echo empty($doc['latitude']) ? 'display:none;' : ''; ?>">
                        ...
                        <div class="form-group">
                            <label
                                style="display:flex;align-items:center;gap:0.4rem;font-size:0.875rem;font-weight:600;">
                                        ...
                                        <div class="attachment-item" id="att-row-<?php echo $a['id']; ?>"
                                            ...
                                            <div style="display:flex;align-items:flex-start;gap:0.6rem;overflow:hidden;flex:1;">
                                                ...
                                                <div style="flex:1;">
                                                    ...
                                                    <input type="text" name="keterangan_exist[<?php echo $a['id']; ?>]"
                                                        value="<?php echo htmlspecialchars($a['keterangan'] ?? ''); ?>"
                                                        placeholder="Tambah/Ubah keterangan lampiran..." class="form-control"
                                                        style="font-size:0.75rem; padding:0.3rem 0.5rem; height:auto; margin-top:0.3rem;"
                                                        autocomplete="off">
                                                </div>
                                            </div>
                                            <div style="display:flex;gap:0.5rem;flex-shrink:0;">
                                                <a href="file_action.php?id=<?php echo $a['id']; ?>&action=view" target="_blank"
                                                    class="btn btn-outline btn-icon" title="Buka / lihat file ini"
                                                    data-tooltip="Lihat file">
                                                    <i data-feather="eye"
                                                        style="width:14px;height:14px;color:var(--primary);"></i>
                                                </a>
                                                <button type="button" class="btn btn-danger btn-icon"
                                                    title="Hapus lampiran ini secara permanen" data-tooltip="Hapus lampiran"
                            ...
                            <?php else: ?>
                                <p style="color:var(--text-light);font-size:0.875rem;font-style:italic;">Belum ada file
                                    terlampir.</p>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="drop-zone" style="position:relative;padding:1.5rem;">
                                ...
                                <div style="text-align:center;">
                                    <i data-feather="plus"
                                        style="width:28px;height:28px;color:var(--border-color);display:block;margin:0 auto 0.5rem;"></i>
                                    <p
                                        style="font-size:0.95rem;color:var(--text-muted);font-weight:600;margin-bottom:0.2rem;">
                                        Pilih File Dokumen</p>
                                    <p style="font-size:0.75rem;color:var(--text-light);">(Bisa pilih lebih dari satu
                                        file/foto)</p>
                                </div>
                        ...
                        <div style="display:flex;gap:0.75rem;margin-top:0.5rem;">
                            ...
                            <button type="button" id="btn-update-trigger" class="btn btn-warning w-full"
            ...
            <div class="modal-overlay" id="del-att-modal" role="dialog" aria-modal="true">
                <div class="modal-box">
                    ...
                    <div class="modal-desc">File lampiran ini akan dihapus permanen.<br><span
                            style="color:var(--danger);font-weight:600;">Tidak bisa dibatalkan!</span></div>
                    <div class="modal-actions">
